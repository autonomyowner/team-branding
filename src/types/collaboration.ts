...
export const STORAGE_KEYS = {
  USERS: 'bt_users',
  CURRENT_USER: 'bt_current_user',
  VISUAL_WORKFLOWS: 'bt_visual_workflows',
  KANBAN_BOARDS: 'bt_kanban_boards',
  KANBAN_TASKS: 'bt_kanban_tasks',
  ROADMAPS: 'bt_roadmaps',
  PROJECTS: 'bt_projects',
  BACKLOG_ITEMS: 'bt_backlog_items',
  NOTIFICATIONS: 'bt_notifications',
  ACTIVITY_FEED: 'bt_activity_feed',
  STATUS_UPDATES: 'bt_status_updates',
  TEAM_MEMBERS: 'bt_team_members',
  TEAM_WORKFLOW_PROJECTS: 'bt_team_workflow_projects',
  TEAM_WORKFLOWS: 'bt_team_workflows',
  PAGES: 'bt_pages',
  PROJECT_ACTIVITY: 'bt_project_activity',
  USER_PRESENCE: 'bt_user_presence',
} as const;
